...
module.exports = {
  ...
  async execute(message, args) {
    ...
    message.channel.send("🔊 ${member.user.tag} a retrouvé la parole grâce à ${message.author.tag}");
    logToChannel(message, `🔊 ${member.user.tag} a retrouvé la parole grâce à ${message.author.tag}`);
